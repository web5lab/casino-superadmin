...
const cryptoOptions = [
  {
    symbol: 'BTC',
    name: 'Bitcoin',
    icon: <img src='https://cryptologos.cc/logos/bitcoin-btc-logo.svg' className="w-6 h-6 text-orange-500" />,
  ...
  },
  {
    symbol: 'ETH',
    name: 'Ethereum',
    icon: <img src='https://cryptologos.cc/logos/ethereum-eth-logo.svg' className="w-6 h-6 text-blue-500" />,
  ...
  },
  {
    symbol: 'Busd',
    name: 'BUSD',
    icon: <img src='https://cryptologos.cc/logos/binance-usd-busd-logo.svg' className="w-6 h-6  rounded-full flex items-center justify-center text-white font-bold text-sm"/>,
    networks: ['ERC20', 'TRC20', 'BEP20'],
    balance: 1250.00,
    price: 1.00,
  },
  {
    symbol: 'Tron',
    name: 'Tron',
    icon: <img src='https://cryptologos.cc/logos/tron-trx-logo.svg' className="w-6 h-6  rounded-full flex items-center justify-center text-white font-bold text-sm"/>,
    networks: ['ERC20', 'TRC20', 'BEP20'],
    balance: 1250.00,
    price: 1.00,
  },
        ...
        <div className="flex mb-10 bg-gray-700/50 rounded-full p-1 backdrop-blur-sm">
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition-colors ${
              mode === 'deposit' ? 'bg-gradient-to-r from-green-500 to-emerald-600 shadow-lg' : 'hover:bg-gray-600/50'
            }`}
          >
            Deposit
          </button>
          <button
            ...
            className={`flex-1 py-2 rounded-lg transition-colors ${
              mode === 'withdraw' ? 'bg-gradient-to-r from-green-500 to-emerald-600 shadow-lg' : 'hover:bg-gray-600/50'
            }`}
          >
            Withdraw
          </button>
